  ...
  return (
    <div>
      <section className="position-relative ">
        <div className="container-fluid myContainer pb-lg-5">
          <div className="row align-items-center pt-lg-5">
            <div className="col-lg-6">
              <div className="position-absolute  position_md_relative w_sm_100 w-50 max-w-641 top-0 start-0">
                <div>
                  <img
                    src={CatDogImg}
                    className="w-100 pt-4 pt-md-3 object_fit translate-x-12"
                    alt="cat dog image"
                  />
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="postision-relative">
                ...
                <p className="ff_PoppinsMedium pt-lg-5 max_w_482 pb-lg-5 pt-3  fc_light fs_mds ">
                ...
                <div className="d-flex flex-col pt-3   pb-4 pb-lg-5">
                  <button className="border-0 book_btn view_btn bg_orange ff_PoppinsMedium mb-3  mb-md-0 fs_md fc_white rounded-3 w_142 h_60 ">
                    Contact us
                  </button>

                  <ul className="d-flex align-items-center m-0 ps-sm-5 ps-3 pt-3 pt-md-0 pb-3 pb-md-0 curser_pointer">
                    <li className="position-relative profile">
                      <img src={Profile1} alt="profile" />
                    </li>
                    <li className="position-relative profile1">
                      <img src={Profile2} alt="profile" />
                    </li>
                    <li className="position-relative profile2">
                      <img src={Profile3} alt="profile" />
                    </li>
                    <li className="position-relative profile3">
                      <img src={Profile4} alt="profile" />
                    </li>
                    <li className="position-relative profile4">
                ...
                <div className="position-relative">
                  ...
                  <p className="ff_PoppinsRegular ps-lg-5 fc_light">
      ...
      <section>
        <div className="container mycontainer pb-md-5 pt-md-5">
          <div className="row position-relative column_reverse ps-3 pe-3">
                    ...
                    <div className="col-lg-4 pe-0  pt-5 pb-2  ">
                      <div className="d-flex flex-column border_0 border-right-white h_72 align-items-center">
                        <ul className="p-0 curser_pointer curser_pointer">
                          <li className="ff_PoppinsRegular pb-2 fc_white fs_xmd ">
                            Adopted
                          </li>
            ...
            <div className="col-lg-5 pe-0 position-absolute position_md_relative pb-0 ps-0  pt-lg-0  end-0 bottom-0">
              <div className="header_card overflow-hidden curser_pointer border_0 m-0">
                <p className="fc_white ff_PoppinsRegular fs_md ms-auto me-auto">
                  Lorem ipsum dolor sit amet, consectetur ipcing elit, sed do
                  eiusmod tempor incididu ut labore et quis nostrud sed do eius
                  .....
                </p>
                <div className="max-w-258 mb-3 mb-sm-0 border-top"></div>
                <div className="d-flex justify-content-between align-item-end">
                  <p className="ff_Slackey fc_white fs_xmd pt-4">
                    Daniel Kahneman
                  </p>
