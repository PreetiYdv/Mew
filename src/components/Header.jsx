              ...
              <div className="row align-items-center pt-lg-5">
                <div className="col-lg-6">
                    <div className='position-absolute  position_md_relative w_sm_100 w-50 max-w-641 top-0 start-0'>
                       <div>
                          <img src={CatDogImg} className='w-100 pt-4 pt-md-5 object_fit' alt="cat dog image" />
                       </div>
                    </div>
                </div>
                <div className="col-lg-6">
                  <div className='postision-relative' >
                    ...
                    <div className='d-flex flex-col pt-3  pb-lg-5'>
                      <button className='border-0 bg_orange ff_PoppinsMedium mb-3  mb-md-0 fs_md fc_white rounded-3 w_142 h_60 '>Contact us</button>

                      <ul className='d-flex ps-sm-5 ps-3 pt-3 pt-md-0 pb-3 pb-md-0 profile_ul'>
          ...
          <section>
            <div className="container pb-md-5 pt-md-5">
                 <div className="row position-relative">
                     <div className='col-lg-12 pe-0 position-relative pe-0 bottom-0 header_card_text'>
                     <div className="row">
                      <div className="col-lg-7">
                       <div className="row pb-md-5 pt-md-4">
                       
                        <div className="col-lg-4 pe-0  pt-5 pb-2  ">
                          <div className='d-flex flex-column  border-right-white h_72   align-items-center'>
                          <ul className='p-0'>
                     ...
                     <div className='col-lg-5 pe-0 position-absolute end-0 bottom-0'>
                        <div className='header_card m-0'>
